...
/* harmony import */ var _components_modal_components_add_contact_modal_add_contact_modal_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/modal_components/add-contact-modal/add-contact-modal.component */ "./src/app/components/modal_components/add-contact-modal/add-contact-modal.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_modal_components_add_contact_modal_add_contact_modal_component__WEBPACK_IMPORTED_MODULE_10__["AddContactModalComponent"]
        ],
        imports: [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_contacts_data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/contacts-data.service */ "./src/app/services/contacts-data.service.ts");
...
/* harmony import */ var _modal_components_add_contact_modal_add_contact_modal_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../modal_components/add-contact-modal/add-contact-modal.component */ "./src/app/components/modal_components/add-contact-modal/add-contact-modal.component.ts");
...
let ContactsComponent = class ContactsComponent {
    constructor(contactsDataService, modalService) {
        ...
        this.editBtnClicked = (contactData, index) => {
        ...
        this.getContactsData = () => {
            this.contactsDataService.getContactsData().subscribe((response) => {
                this.contactsData = response;
            });
        };
        this.deleteBtnClicked = (contactData) => {
            this.showAddEditForm = false;
            this.contactsDataService.deleteContact(contactData).subscribe(() => {
                this.contactsData = underscore__WEBPACK_IMPORTED_MODULE_5__["filter"](this.contactsData, (eachContactData) => {
                    return contactData.id !== eachContactData.id;
                });
            });
        };
        this.shareBtnClicked = (index) => {
        ...
        this.saveContact = () => {
            if (this.formData.phNumber.toString().length === 10) {
                ...
                if (this.formButtonText === 'Save') {
                    this.contactsDataService.addnewContact(this.formData).subscribe((response) => {
                        this.contactsData.push(response);
                    });
                }
                else {
                    this.contactsDataService.updateContact(this.formData).subscribe((response) => {
                        let contactsData = underscore__WEBPACK_IMPORTED_MODULE_5__["map"](this.contactsData, (contactData) => {
...
ContactsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./contacts.component.scss */ "./src/app/components/contacts/contacts.component.scss")).default]
    })
], ContactsComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddContactModalComponent", function() { return AddContactModalComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let AddContactModalComponent = class AddContactModalComponent {
...
AddContactModalComponent.ctorParameters = () => [
    { type: ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["BsModalRef"] }
];
AddContactModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-contact-modal',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-contact-modal.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/modal_components/add-contact-modal/add-contact-modal.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-contact-modal.component.scss */ "./src/app/components/modal_components/add-contact-modal/add-contact-modal.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContactsDataService", function() { return ContactsDataService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
module.exports = __webpack_require__(/*! F:\Tech\SampleApplications\EvolentAssignment\ContactInfoWebApp\src\main.ts */"./src/main.ts");
